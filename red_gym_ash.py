...
class RedGymEnv(Env):
    ...
    def path_reward(self,current_position):
        # Define the path with rewards
        path = [
            (134,181),(134,182),(134,183),(134,184),(134,185),(134,186),(134,187),(134,188),
            (122,188),(122,189),(122,190),(122,191),(122,192),(122,193),(122,194),(122,195),(122,196),(122,197),(122,198),(122,199),(122,200),(122,201),(122,202),(122,203),(122,204),
            (114,204),(114,203),(114,202),(114,201),(114,200),(114,199),(114,198),(114,197),(114,196),(114,195),(114,194),(114,193),(114,192),(114,191),(114,190),(114,189),(114,188),(114,187),(114,186),(114,185),(114,184),(114,183),(114,182),
            (127,182),(127,183),(127,184),
            (131,184),(131,183),(131,182),(131,181),(131,180),(131,179),(131,178),(131,177),
            (131,184),(131,183),(131,182),(131,181),(131,180),(131,179),(131,178),(131,177),
            (117,177),(117,176),(117,175),(117,174),(117,173),(117,172),
        ]

        # Base reward for following the path
        base_reward = 10
        # Higher reward for reaching the target
        goal_reward = 100

        # Check if current position matches the next position in the path
        if current_position in path:
            if current_position == (117, 172):
                return goal_reward
            else:
                return base_reward
        else:
            # Penalize for deviating from the path
            return -5
    ...
    def get_game_state_reward(self, print_stats=False):
        ...
        #add the code to get a reward for exploring here 
     
        explore = self.path_reard(self.get_global_coords())
        print('the explore reward is {explore}')
        state_scores = {
